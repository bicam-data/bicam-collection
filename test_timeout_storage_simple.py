#!/usr/bin/env python3
"""
Simple test script to verify timeout storage without relying on regex processing.

This test creates a custom processing function that will definitely timeout.
"""
...
async def test_simple_timeout():
    """Test timeout mechanism with a simple function."""
    ...
    try:
        ...
        run_id = await initialize_run(
            ...
            total_filings=1,
            total_sections=1,
            parameters={"description": "Simple timeout test", "test": True},
        )
...
if __name__ == "__main__":
    asyncio.run(test_simple_timeout())
