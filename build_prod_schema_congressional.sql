-- PROD TABLES
DROP SCHEMA IF EXISTS staging_congressional CASCADE;
CREATE SCHEMA IF NOT EXISTS staging_congressional;
...
CREATE TABLE IF NOT EXISTS staging_congressional.congresses_sessions(
...
CREATE TABLE staging_congressional.ref_bill_summary_version_codes AS
SELECT
...
ALTER TABLE staging_congressional.ref_bill_summary_version_codes
ADD CONSTRAINT unique_version_code_chamber UNIQUE (version_code, chamber);

CREATE TABLE staging_congressional.ref_title_type_codes AS
SELECT
...
ALTER TABLE staging_congressional.ref_title_type_codes
ADD PRIMARY KEY (title_type_code);

-- 2. Base tables that have no or simple dependencies
CREATE TABLE IF NOT EXISTS staging_congressional.members(
...
CREATE TABLE IF NOT EXISTS staging_congressional.committees(
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills(
...
CREATE TABLE IF NOT EXISTS staging_congressional.hearings(
...
CREATE TABLE IF NOT EXISTS staging_congressional.treaties(
...
CREATE TABLE IF NOT EXISTS staging_congressional.nominations(
...
CREATE TABLE IF NOT EXISTS staging_congressional.amendments(
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_summaries(
    bill_id TEXT,
    action_date DATE,
    action_desc TEXT,
    text TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_titles(
    bill_id TEXT,
    title TEXT,
    title_type TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeeprints(
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeereports(
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings(
...
CREATE TABLE IF NOT EXISTS staging_congressional.amendments_sponsors(
    amendment_id TEXT,
    bioguide_id TEXT,
    PRIMARY KEY (amendment_id, bioguide_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.amendments_cosponsors(
    amendment_id TEXT,
    bioguide_id TEXT,
    PRIMARY KEY (amendment_id, bioguide_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.amendments_amended_bills(
    amendment_id TEXT,
    bill_id TEXT,
    PRIMARY KEY (amendment_id, bill_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.amendments_amended_treaties(
    amendment_id TEXT,
    treaty_id TEXT,
    PRIMARY KEY (amendment_id, treaty_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.amendments_amended_amendments(
    amendment_id TEXT,
    amended_amendment_id TEXT,
    PRIMARY KEY (amendment_id, amended_amendment_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.amendments_actions(
...
CREATE TABLE IF NOT EXISTS staging_congressional.amendments_actions_recorded_votes(
    action_id TEXT,
    amendment_id TEXT,
    chamber TEXT,
    congress INTEGER,
...
CREATE TABLE IF NOT EXISTS staging_congressional.amendments_texts(
    amendment_id TEXT,
    date TIMESTAMP WITH TIME ZONE,
    type TEXT,
    raw_text TEXT,
    pdf TEXT,
    html TEXT,
    UNIQUE (amendment_id, date, type, pdf, html)
);

-- Bills related tables
CREATE TABLE IF NOT EXISTS staging_congressional.bills_texts(
    bill_id TEXT,
    date TEXT,
    type TEXT,
    raw_text TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_actions(
    action_id TEXT PRIMARY KEY,
    bill_id TEXT,
    action_code TEXT,
    action_date DATE,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_actions_committees(
    action_id TEXT,
    bill_id TEXT,
    committee_code TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_actions_recorded_votes(
    action_id TEXT,
    bill_id TEXT,
    chamber TEXT,
    congress INTEGER,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_related_bills(
    bill_id TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_cbocostestimates(
    bill_id TEXT,
    description TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_cosponsors(
    bill_id TEXT,
    bioguide_id TEXT,
    PRIMARY KEY (bill_id, bioguide_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.bills_laws(
    bill_id TEXT,
    law_id TEXT,
    law_number TEXT,
    law_type TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.bills_sponsors(
    bill_id TEXT,
    bioguide_id TEXT,
    PRIMARY KEY (bill_id, bioguide_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.bills_subjects(
    bill_id TEXT,
    subject TEXT,
    updated_at TIMESTAMP WITH TIME ZONE,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeeprints_associated_bills(
    print_id TEXT,
    bill_id TEXT,
    PRIMARY KEY (print_id, bill_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeeprints_committees(
    print_id TEXT,
    committee_code TEXT,
    PRIMARY KEY (print_id, committee_code)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeeprints_texts(
    print_id TEXT,
    raw_text TEXT,
    formatted_text TEXT,
    pdf TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeereports_associated_bills(
    report_id TEXT,
    bill_id TEXT,
    PRIMARY KEY (report_id, bill_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeereports_associated_treaties(
    report_id TEXT,
    treaty_id TEXT,
    PRIMARY KEY (report_id, treaty_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeereports_texts(
    report_id TEXT,
    raw_text TEXT,
    formatted_text TEXT,
...
-- committees related
CREATE TABLE IF NOT EXISTS staging_congressional.committees_bills(
    committee_code TEXT,
    bill_id TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committees_history(
    committee_code TEXT,
    name TEXT,
    loc_name TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committees_subcommittees(
    committee_code TEXT,
    subcommittee_code TEXT,
    PRIMARY KEY (committee_code, subcommittee_code)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committees_committeereports(
    committee_code TEXT,
    report_id TEXT,
...
-- hearings related
CREATE TABLE IF NOT EXISTS staging_congressional.hearings_committees(
    hearing_id TEXT,
    committee_code TEXT,
    PRIMARY KEY (hearing_id, committee_code)
);

CREATE TABLE IF NOT EXISTS staging_congressional.hearings_dates(
    hearing_id TEXT,
    hearing_date DATE,
    PRIMARY KEY (hearing_id, hearing_date)
);

CREATE TABLE IF NOT EXISTS staging_congressional.hearings_texts(
    hearing_id TEXT,
    raw_text TEXT,
    pdf TEXT,
    formatted_text TEXT,
...
-- members related
CREATE TABLE IF NOT EXISTS staging_congressional.members_terms(
    bioguide_id TEXT,
    member_type TEXT,
    chamber TEXT,
    congress INTEGER,
...
CREATE TABLE IF NOT EXISTS staging_congressional.members_party_history(
    bioguide_id TEXT,
    party_code TEXT,
    party_name TEXT,
    start_year INTEGER,
...
-- nominations related
CREATE TABLE IF NOT EXISTS staging_congressional.nominations_actions(
    action_id TEXT PRIMARY KEY,
    nomination_id TEXT,
    action_code TEXT,
    action_type TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.nominations_positions(
    nomination_id TEXT,
    ordinal INTEGER,
    position_title TEXT,
    organization TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.nominations_actions_committees(
    action_id TEXT,
    nomination_id TEXT,
    committee_code TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.nominations_committeeactivities(
    nomination_id TEXT,
    committee_code TEXT,
    activity_name TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.nominations_associated_hearings(
    nomination_id TEXT,
    hearing_id TEXT,
    PRIMARY KEY (nomination_id, hearing_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.nominations_nominees(
    nomination_id TEXT,
    ordinal INTEGER,
    first_name TEXT,
    middle_name TEXT,
...
-- treaties related
CREATE TABLE IF NOT EXISTS staging_congressional.treaties_actions(
    action_id TEXT PRIMARY KEY,
    treaty_id TEXT,
    action_code TEXT,
    action_date DATE,
...
CREATE TABLE IF NOT EXISTS staging_congressional.treaties_actions_committees(
    action_id TEXT,
    treaty_id TEXT,
    committee_code TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.treaties_country_parties(
    treaty_id TEXT,
    country TEXT,
    PRIMARY KEY (treaty_id, country)
);

CREATE TABLE IF NOT EXISTS staging_congressional.treaties_index_terms(
    treaty_id TEXT,
    index_term TEXT,
    PRIMARY KEY (treaty_id, index_term)
);

CREATE TABLE IF NOT EXISTS staging_congressional.treaties_titles(
    treaty_id TEXT,
    title TEXT,
    title_type TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_associated_bills(
    meeting_id TEXT,
    bill_id TEXT,
    PRIMARY KEY (meeting_id, bill_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_associated_treaties(
    meeting_id TEXT,
    treaty_id TEXT,
    PRIMARY KEY (meeting_id, treaty_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_associated_nominations(
    meeting_id TEXT,
    nomination_id TEXT,
    PRIMARY KEY (meeting_id, nomination_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_meeting_documents(
    meeting_id TEXT,
    name TEXT,
    document_type TEXT,
    description TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_witness_documents(
    meeting_id TEXT,
    document_type TEXT,
    url TEXT,
    UNIQUE (meeting_id, url)
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_witnesses(
    meeting_id TEXT,
    name TEXT,
    position TEXT,
    organization TEXT,
...
CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_associated_hearings(
    meeting_id TEXT,
    hearing_id TEXT,
    PRIMARY KEY (meeting_id, hearing_id)
);

CREATE TABLE IF NOT EXISTS staging_congressional.committeemeetings_committees(
    meeting_id TEXT,
    committee_code TEXT,
