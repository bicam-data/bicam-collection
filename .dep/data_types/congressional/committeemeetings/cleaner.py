"""
Committee meetings data cleaner.

This module handles cleaning and validation of Congressional committee meetings data,
...
class CommitteemeetingsCleaner(CongressionalBaseCleaner):
    """
    Committee meetings-specific cleaner that extends CongressionalBaseCleaner with committee meetings-specific cleaning logic.

    Provides specialized cleaning methods for all committee meetings-related data types
    ...
    def __init__(
        ...
        """
        Initialize committee meetings cleaner using base class.
        ...
        Args:
            ...
            data_type_name: Data type name (defaults to "committeemeetings")
