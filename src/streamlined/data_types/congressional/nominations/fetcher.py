...
class NominationsFetcher(CongressionalBaseFetcher):
    ...
    async def get_nominations_actions(
        ...
        result = await self.get_generic_related_data(
            full_nomination_data, related_table_name="actions"
        )
        logger.debug(
    ...
    async def get_nominations_hearings(
        ...
        result = await self.get_generic_related_data(
            full_nomination_data, related_table_name="hearings"
        )
        logger.debug(
    ...
    async def get_nominations_individualnominees(
        ...
        for nominee_info in nominees_array:
            ...
            try:
                ...
                nominees_data = await self.client.retrieve_related_data_from_url(
