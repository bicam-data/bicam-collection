"""
Amendments data cleaner.

This module handles cleaning and validation of Congressional amendments data,
...
class AmendmentsCleaner(CongressionalBaseCleaner):
    ...
    def __init__(
        ...
        """
        Initialize amendments cleaner using base class.
        ...
        Args:
            ...
            data_type_name: Data type name (defaults to "amendments")
