...
_global_registry: ConsolidatedRegistry | None = None


def get_consolidated_registry() -> ConsolidatedRegistry:
    """Get the global consolidated registry instance."""
    global _global_registry
    if _global_registry is None:
        _global_registry = ConsolidatedRegistry()
...
def get_plugin_registry():
    ...
    return get_consolidated_registry()
...
def list_data_types() -> list[str]:
    ...
    return get_consolidated_registry().list_data_types()
