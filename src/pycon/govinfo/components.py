...
class BillCollection(Retriever):
    ...
    def __init__(self, data: dict, _pagination: dict, _adapter: RestAdapter, _id_package_init: tuple | None = None):
        self.data = data
    ...
    @property
    def collection_code(self) -> str | None:
    ...
    @property
    def bill_version(self) -> str | None:
    ...
    @property
    def current_chamber(self) -> str | None:
    ...
    @property
    def is_appropriation(self) -> bool | None:
        return getattr(self, '_is_appropriation', None)

    @property
    def government_author1(self) -> str | None:
        return getattr(self, '_government_author1', None)

    @property
    def government_author2(self) -> str | None:
    ...
    @property
    def su_doc_class_number(self) -> str | None:
        return getattr(self, '_su_doc_class_number', None)

    @property
    def pages(self) -> int | str | None:
        return getattr(self, '_pages', None)

    @property
    def reference_bills(self) -> list[ReferenceBill] | None:
        return getattr(self, '_bill_references', [])

    @property
    def reference_laws(self) -> list[ReferenceLaw] | None:
        return getattr(self, '_law_references', [])

    @property
    def reference_statutes(self) -> list[ReferenceStatute] | None:
        return getattr(self, '_statute_references', [])

    @property
    def reference_codes(self) -> list[ReferenceCode] | None:
        return getattr(self, '_code_references', [])

    @property
    def migrated_doc_id(self) -> str | None:
        return getattr(self, "_migrated_doc_id", None)

    @property
    def parent_ils_system_id(self) -> str | None:
        return getattr(self, "_parent_ils_system_id", None)

    @property
    def child_ils_title(self) -> str | None:
        return getattr(self, "_child_ils_title", None)

    @property
    def parent_ils_title(self) -> str | None:
        return getattr(self, "_parent_ils_title", None)

    @property
    def child_ils_system_id(self) -> str | None:
        return getattr(self, "_child_ils_system_id", None)

    @property
    def stock_number(self) -> str | None:
    ...
    @property
    def premis_url(self) -> str | None:
        return getattr(self, "_premis_link", None)

    @property
    def xml_url(self) -> str | None:
    ...
    @property
    def short_titles(self) -> list[ShortTitle] | None:
...
class CongressionalDirectoryPackage(Retriever):
    ...
    @property
    def ils_system_id(self) -> str | None:
        return getattr(self, "_ils_system_id", None)

    @property
    def isbn(self) -> list[str] | None:
    ...
    @property
    def granules_url(self) -> str | None:
...
class MemberGranule(Retriever):
    ...
    def _parse_online(self):
        ...
        for item in self._online:
            if "gov" in item:
                self._official_url = item
            elif "facebook" in item:
                self._facebook_url = item
            elif "twitter" in item:
                self._twitter_url = item
            elif "youtube" in item:
                self._youtube_url = item
            elif "instagram" in item:
                self._instagram_url = item
            else:
                self._other_url = item
    ...
    @property
    def granule_class(self) -> str | None:
    ...
    @property
    def sub_granule_class(self) -> str | None:
        return getattr(self, '_sub_granule_class', None)

    @property
    def gpo_id(self) -> str | None:
...
class CongressionalReportPackage(Retriever):
    ...
    @property
    def serial_details(self) -> SerialSet | None:
...
class TreatyPartGranule(Retriever):
    ...
    @property
    def is_graphics_in_pdf(self) -> bool | None:
...
class HearingPartGranule(Retriever):
    ...
    @property
    def graphics_in_pdf(self) -> bool | None:
    ...
    @property
    def jacketnumber(self) -> str | None:
    ...
    @property
    def witnesses(self) -> str | list[str] | None:
        return self._witnesses if isinstance(self._witnesses, list) else [self._witnesses]
