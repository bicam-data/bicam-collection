...
class PyCongress:
    ...
    async def get_bulk_bills(self, congress: int | None = None, bill_type: str | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[list[Bill]]:
    ...
    async def get_bulk_amendments(self, congress: int | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[list[Amendment]]:
    ...
    async def get_bulk_committees(self, congress: int | None = None,
    ...
    async def get_bulk_committeereports(self, congress: int | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[CommitteeReport]:
    ...
    async def get_bulk_committeeprints(self, congress: int | None = None, chamber: Literal["house", "senate", "joint"] | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[CommitteePrint]:
    ...
    async def get_bulk_committeemeetings(self, congress: int | None = None, chamber: Literal["house", "senate", "joint"] | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[CommitteeMeeting]:
    ...
    async def get_bulk_hearings(self, congress: int | None = None, chamber: Literal["house", "senate"] | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[Hearing]:
    ...
    async def get_bulk_nominations(self, congress: int | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[Nomination]:
    ...
    async def get_bulk_treaties(self, congress: int | None = None, from_date: str = "", to_date: str = "", **kwargs) -> AsyncIterator[Treaty]:
