"""
Specialized Resource Managers for Bicam Processing

This module breaks down the God Object pattern by creating focused managers
for each major responsibility. Each manager has a single responsibility
